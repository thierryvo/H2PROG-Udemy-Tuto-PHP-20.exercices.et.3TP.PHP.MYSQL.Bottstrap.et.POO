...
$titre = "Partie 8 - POO Liste déroulante et Formulaire + SESSION - Les armes Class Arme."; //Mettre le nom du titre de la page que vous voulez
// CONTENU: Partie 8
// ----------------------------------------------------------------------------------------------------------- BACK
// variables
class Arme{
...
// ISSET level ---------------------------------------------------------------------------------------------- ISSET
if(
    isset($_GET['levelépée']) ||
    isset($_GET['levelarc']) ||
    isset($_GET['levelhache']) ||
    isset($_GET['levelfleau']) ){        
        // avant:
    ...
    foreach($armes as $key => $value){
        ...
        <div class="row align-items-center margetop20">
            ...
            <div class="col-2 pour-le-selecteur-level text-center">
                ...
                <form action="partie8.php" method="GET">
                    <select name="niveau<?= $value->getNom() ?>" onChange="submit()">
